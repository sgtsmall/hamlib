 ...
 *
 * ft991.c - (C) Alex Stewart 2015 (vk2psf at arrl.net)
 *
...
const struct rig_caps ft991_caps = {
    ...
    .transceive =         RIG_TRN_OFF,        /* May enable later as the 991 has an Auto Info command */
    .bank_qty =           0,
    .chan_desc_sz =       0,
    ...
    .tuning_steps =       {
        ...
        {FT991_AM_RX_MODES,     Hz(10)},   /* Normal */
        {FT991_AM_RX_MODES,     Hz(100)},    /* Fast */
 ...
 .filters =            {
        {FT991_CW_RTTY_PKT_RX_MODES,  Hz(3000)},    /* Wide   CW, RTTY, PKT */
        ...
        {FT991_CW_RTTY_PKT_RX_MODES,  Hz(450)},     /*        CW, RTTY, PKT */
        {FT991_CW_RTTY_PKT_RX_MODES,  Hz(400)},     /*        CW, RTTY, PKT */
        {FT991_CW_RTTY_PKT_RX_MODES,  Hz(350)},     /*        CW, RTTY, PKT */
        {FT991_CW_RTTY_PKT_RX_MODES,  Hz(300)},     /*        CW, RTTY, PKT */
        {FT991_CW_RTTY_PKT_RX_MODES,  Hz(250)},     /*        CW, RTTY, PKT */
        {FT991_CW_RTTY_PKT_RX_MODES,  Hz(200)},     /*        CW, RTTY, PKT */
        {FT991_CW_RTTY_PKT_RX_MODES,  Hz(150)},     /*        CW, RTTY, PKT */
        {FT991_CW_RTTY_PKT_RX_MODES,  Hz(100)},     /*        CW, RTTY, PKT */
        {FT991_CW_RTTY_PKT_RX_MODES,  Hz(50)},     /*        CW, RTTY, PKT */
        {RIG_MODE_SSB,                Hz(3200)},    /* Normal SSB */
        {RIG_MODE_SSB,                Hz(3000)},    /* Narrow SSB */
        {RIG_MODE_SSB,                Hz(2900)},    /* Wide   SSB */
